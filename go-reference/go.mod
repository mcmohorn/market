module github.com/mcmohorn/market/server

go 1.16

require (
	astuart.co/go-robinhood v1.5.0
	github.com/PokemonTCG/pokemon-tcg-sdk-go v0.0.0-20181002102828-dc3327e03e0d // indirect
	...
	github.com/kilpatty/nomics-go v0.0.0-20180814150253-94502f0acf5d // indirect
